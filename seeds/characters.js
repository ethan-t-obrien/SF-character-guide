    ...
    .then(function () {
      ...
      return knex('characters').insert([
        ...
        {CharacterId: 4, 
          ...
          height: 154, 
          weight: 55, 
          likes: 'Rindoukan-ryuu Karate, a challenge, Ibuki, Ryu', 
          dislikes: "Being called a boy, not being taken seriously", 
          fightingStyle: 'Rindoukan-ryuu Karate', 
          story: "Makoto is a young Japanese girl, trained in Rindoukan karate. Her karate style is very similar to that of Shotokan karate. Although having little fashion sense for a girl her age, she still hates it when she is mistaken for a boy. She develops something of a friendship with Ibuki, as shown by their alternate opening when they fight each other or train with each other.Since her father's death, Makoto's dojo has been floundering and her older brother decided to become a businessman, leaving Makoto to elevate her dojo back to its former glory. Horrified to discover the decrepit state the dojo is in, she first enters S.I.N's tournament in Super Street Fighter IV in order to win money to renovate it. Although she didn't win any prize money after defeating honorable fighters, she did decide to rebuild her father's dojo by hand, and make money the old-fashioned way. ", 
          personality: "A hot-headed, rough and tumble karate girl, Makoto was born into the prestigious Rindoukan (Bellflower) Karate dojo. She has a very tomboy type personality and speaks with an uncommon Tosa dialect. Although she's still young and a bit short, her black belt isn't just for show; her karate form is very impressive. Her trademarks are her father's white gi and a yellow headband (which she wears like a scarf around her neck)."}
      ]);
    });
};
